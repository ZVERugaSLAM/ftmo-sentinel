        ...
        if st.button("Згенерувати актуальний звіт 'Великої п'ятірки'", type="primary"):
            with st.spinner("Синтез даних системного ризику..."):
                ...
                try:
                    ...
                    1) Де-інверсія кривої дохідності (10Y-2Y): +0.60%
                    ...
                    Вимоги до звіту:
                    1. Синтез (Не перелічуй індикатори як список): Поясни їхній взаємозв'язок. Наприклад, як критичне виснаження RRP ($0.5B) у поєднанні з де-інверсією впливає на міжбанківський ринок та загрожує кредитним стиском, незважаючи на низький High Yield Spread.
