    ...
    def render_crisis():
        ...
        if st.button("Згенерувати актуальний звіт 'Великої п'ятірки'"):
            with st.spinner("Синтез даних системного ризику..."):
                report_prompt = """
                Сформуй жорсткий звіт про ризик обвалу ринку на основі 5 індикаторів:
                1) Де-інверсія кривої дохідності (+0.60%). 2) Виснаження Reverse Repo ($0.5B).
                3) High Yield Spread (2.86%). 4) Sahm Rule (0.30%). 5) Job Search (+12%).
                Зроби чіткий висновок для DXY та XAUUSD.
                """
