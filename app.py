        ...
        if st.button("Згенерувати актуальний звіт 'Великої п'ятірки'", type="primary"):
            with st.spinner("Синтез даних системного ризику..."):
                ...
                try:
                    ...
                    report_prompt = """
                    Сформуй жорсткий макроекономічний звіт про системний ризик.

                    Вхідні дані:
                    1) Де-інверсія кривої дохідності: +0.60%
                    2) Reverse Repo (RRP): $0.5B
                    3) High Yield Spread: 2.86%
                    4) Sahm Rule: 0.30%
                    5) Job Search: +12%
                    
                    Суворо дотримуйся наступної структури:
                    1. Таблиця: Створи Markdown-таблицю з трьома колонками (Індикатор | Фактичне значення | Оцінка ризику). Заповни її для всіх 5 індикаторів.
                    2. Ліквідність: Оціни ризик нестачі доларової ліквідності.
                    3. Прогноз: Зроби чіткий висновок щодо напрямку руху DXY та XAUUSD.
                    
                    Формат: лаконічний, діловий. Жодних загальних фраз.
                    """
